        ...
        <ul class="nav navbar-nav">
            ...
            <li class="menu-item-has-children dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                   aria-expanded="false"> <i class="menu-icon fa fa-bars"></i>Categories</a>
                <ul class="sub-menu children dropdown-menu">
                    <li><i class="fa fa-folder"></i><a href="Categories_add.php">Categories</a></li>
                    <li><i class="fa fa-folder-open"></i><a href="Categories_all.php">Sub Categories</a></li>
                </ul>
            </li>
            <!---------------------Categories END--------------------------------------->
            <li class="menu-item-has-children dropdown">
            ...
            <li class="menu-item-has-children dropdown">
                ...
                <ul class="sub-menu children dropdown-menu">
                    ...
                    <li><i class="menu-icon fa fa-th"></i><a href="forms-editor.html">Editor Form</a></li>
                </ul>
            </li>
